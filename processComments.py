...
def ComputeVocabulary():
	...
	fileWriter = csv.writer(open("data/vocab5.csv", "wb"),delimiter=",")
...
def ComputeCommentArticleRelevance():
	...
	fileWriter = csv.writer(open("data/comment_study_article_relevance99.csv", "w+"),delimiter=",")
...
def ComputeCommentConversationalRelevance():
	...
	fileWriter = csv.writer(open("data/comment_study_comment_conversational_relevance3.csv", "w+"),delimiter=",")
	nc = 0
	for a in articles:
		print a
		comments = articles[a]
